...
def_filestructure <- function() {
  ...
  in_GRDCp <- file.path(outgdb, 'GRDCstations_riverjoin') 
  ...
  out_GRDC <- file.path(resdir, 'GRDCstations_predbasic800.gpkg') 
  ...
  return(c(rootdir=rootdir, datdir=datdir, resdir=resdir, outgdb=outgdb, 
           in_GRDCp=in_GRDCp, in_riveratlas_meta=in_riveratlas_meta, 
           out_GRDC=out_GRDC, in_riveratlas=in_riveratlas))
}
