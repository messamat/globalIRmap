...
`r length(tasks_featsel_u10$classif$feature_names)`
- Total number of predictor variables kept in model for gauges >= 1 m3/s:            
`r length(tasks_featsel_o1$classif$feature_names)`
...
```{r variable-importance, fig.width=6, fig.height=5, dpi=600, echo=FALSE}
loadd(vimp_plot_u10)
loadd(vimp_plot_o1)
