...
print(paste0('For a total river length of ',IRESextra[, sum(cumL_pred)], ' km'
             ))
...
getdisplay_totalest <- function(target, subtarget='data') {
  flextable(target[[subtarget]] %>%
              rbind(.[bin>1, list(bin='world',
...
getdisplay_totalest(au_plot_mdur30)
