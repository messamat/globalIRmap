...
loadd(tablebm_classif1_o10)
loadd(tablebm_regr1_o10)
loadd(tablebm_classif2_o10)
setup_table_o10 <- rbindlist(list(tablebm_classif1_o10$setup,
                              tablebm_regr1_o10$setup,
                              tablebm_classif2_o10$setup),
                         fill=T, use.names=T)

flextable(setup_table_o10)

results_table_o10 <- rbindlist(list(tablebm_classif1_o10$results,
                              tablebm_regr1_o10$results,
                              tablebm_classif2_o10$results),
                         fill=T, use.names=T)
flextable(results_table_o10)
```
...
loadd(misclass_plot_o10)
print(misclass_plot_o10)
...
loadd(pd_plot_o10)
lapply(pd_plot_o10, function(p) plot(p))
```
...
# 
# loadd(gaugeIPR_plot_o10)
# print(gaugeIPR_plot_o10["gaugeIPR_numplot"])
```
