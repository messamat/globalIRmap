...
```{r comparison, echo = FALSE, fig.width = 6, fig.height = 6,  dpi=600}
loadd(fr_plot)
loadd(us_plot)

grid.arrange(fr_plot, us_plot, left = 'Prevalence of intermittency (% river length)') 
```
